...
CurePotion::CurePotion(int xPos, int yPos)
        : Potion(xPos, yPos, '+', COLOR_PAIR(MapUtils::POTION), OBJECT), value(3) {}
...
StrengthenPotion::StrengthenPotion(int xPos, int yPos)
        : Potion(xPos, yPos, '!', COLOR_PAIR(MapUtils::POTION), OBJECT), value(1) {}
...
DefendPotion::DefendPotion(int xPos, int yPos)
        : Potion(xPos, yPos, 'U', COLOR_PAIR(MapUtils::POTION), OBJECT), value(1) {}
